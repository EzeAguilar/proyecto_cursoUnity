...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerScript_Update_m4D494E3B0D30EA109D7BCFFF6C40085D429E68B0 (PlayerScript_tE076C73DDA6A5F8E4029DF5D763FB2E5C79B3D35* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		if ((!(((double)((double)L_5)) <= ((double)(-852.89999999999998)))))
		{
			goto IL_003d;
		}
	}
...
IL_003d:
	{
		...
		float L_8 = V_0;
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&V_1), (0.0f), (0.0f), L_8, NULL);
		...
		float L_19 = __this->___ForceAdelante_5;
		...
		NullCheck(L_18);
		Rigidbody_AddForce_m7A3EEEED21F986917107CBA6CC0106DCBC212198(L_18, L_22, NULL);
		// }
		return;
	}
}
